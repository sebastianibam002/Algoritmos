...
void generate_vector(unsigned int size, vector<int>& v, minstd_rand0& rng){
  v.clear();
  const unsigned int max_num = size;
...
void generate_ordered_vector(unsigned int size, vector<int>& v, minstd_rand0& rng, bool inv){
  v.clear();
